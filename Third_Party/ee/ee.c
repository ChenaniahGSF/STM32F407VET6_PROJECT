...
#define FLASH_SIZE                          ((((uint32_t)(*((uint16_t *)FLASHSIZE_BASE)) & (0xFFFFU))) * 1024)
/*
 * Sector 0  0x08000000  16KB  0x08000000~0x08003FFF
 * Sector 1  0x08004000  16KB  0x08004000~0x08007FFF
 * Sector 2  0x08008000  16KB  0x08008000~0x0800BFFF
 * Sector 3  0x0800C000  16KB  0x0800C000~0x0800FFFF
 * Sector 4  0x08010000  64KB  0x08010000~0x0801FFFF
 * Sector 5  0x08020000  128KB 0x08020000~0x0803FFFF
 * Sector 6  0x08040000  128KB 0x08040000~0x0805FFFF
 * Sector 7  0x08060000  128KB 0x08060000~0x0807FFFF
 * */
#endif
